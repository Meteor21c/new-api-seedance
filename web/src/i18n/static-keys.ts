...
export const STATIC_I18N_KEYS = [
  ...
  'Loading models from Channels',
  'No available image models are configured in Channels',
  '{{count}} available video models',
  'No available video models are configured in Channels',
  'Video Generation',
  'Create asynchronous videos and track task status',
  ...
  'Resolution {{resolution}} is not supported by the selected model',
  'Allowed range: 3–15',
  'Audio changes the listed price',
  'Grok video includes audio by default; the toggle is not configurable',
  'Grok video does not support separate start and end frames',
  'Upload up to {{count}} static JPG, PNG, or WEBP images, up to 10 MiB each.',
  'Select no more than {{count}} reference images',
  'Kling Omni requires audio off with a reference video',
  ...
  'Wait for the current video task to finish before submitting another',
  'Form reset',
  'Restore template',
  'Template restored',
  'Delete record',
  ...
  'Amount charged',
  'In progress',
  'Review the result and parameters used for this video',
  'Review or save your latest generated videos',
  'The upstream API account has not been assigned a provider for this model. Enable the model in the upstream FZYinghe account or contact its support.',
  'The upstream provider could not detect the model price on its Generate page. This is an upstream provider availability or pricing-adapter issue, not the local New API price.',
  'Price comparison',
  'Site price refreshes automatically from backend configuration',
  'Per-second billing',
  'Site price',
  'Official reference price',
  'Discount ratio',
  'Equivalent to {{discount}}/10 of official price',
  '{{percent}}% of official price',
  'Official reference unavailable',
  'Official reference is from FZYinghe model marketplace',
  'With input video',
  'Without input video',
  'Estimated {{duration}}-second total',
  'No content to copy',
