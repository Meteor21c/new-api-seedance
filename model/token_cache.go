...
redis.call('HSET', KEYS[1],
  ...
  'AutoGroups', ARGV[14], 'SmartText', ARGV[15], 'SmartRoutePolicy', ARGV[16],
  'RemainQuota', ARGV[17], 'UsedQuota', ARGV[18])
redis.call('EXPIRE', KEYS[1], ARGV[19])
return 1`
	...
	return common.RDB.Eval(context.Background(), script, []string{
		...
		token.AutoGroups, strconv.FormatBool(token.SmartText), token.SmartRoutePolicy,
